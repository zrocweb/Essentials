 ...
 *
 * <ul> <li>Country edition -- this is the most common version of the database. It includes the name of the country and
 * it's ISO country code given an IP address. <li>Region edition -- includes the country information as well as what
 * U.S. state or Canadian province the IP address is from if the IP address is from the U.S. or Canada. <li>City edition
 * -- includes country, region, city, postal code, latitude, and longitude information. <li>Org edition -- includes
 * netblock owner. <li>ISP edition -- ISP information. </ul>
 *
