 ...
 * address. See the DatabaseInfo class for further details.<p>
 *
 ...
 * </pre>
 *
 * In general, a single LookupService instance should be created and then reused repeatedly.<p>
 *
...
public class LookupService
{
	...
	String getDnsAttributes(String ip)
	{
		try
		{
			...
			Attributes attrs = ictx.getAttributes(licenseKey + "." + ip + ".s.maxmind.com", new String[]
					{
						"txt"
					});
