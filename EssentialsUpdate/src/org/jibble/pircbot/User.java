...
/**
 * This class is used to represent a user on an IRC server. Instances of this class are returned by the getUsers method
 * in the PircBot class. <p> Note that this class no longer implements the Comparable interface for Java 1.1
...
public class User
{
	...
	/**
	 * Returns the prefix of the user. If the User object has been obtained from a list of users in a channel, then this
	 * will reflect the user's status in that channel.
	 *
	...
	/**
	 * Returns whether or not the user represented by this object is an operator. If the User object has been obtained
	 * from a list of users in a channel, then this will reflect the user's operator status in that channel.
	 *
	...
	/**
	 * Returns whether or not the user represented by this object has voice. If the User object has been obtained from a
	 * list of users in a channel, then this will reflect the user's voice status in that channel.
	 *
	...
	/**
	 * Returns true if the nick represented by this User object is the same as the argument. A case insensitive
	 * comparison is made.
	 *
	...
	/**
	 * Returns true if the nick represented by this User object is the same as the nick of the User object given as an
	...
	/**
	 * Returns the result of calling the compareTo method on lowercased nicks. This is useful for sorting lists of User
	 * objects.
	 *
