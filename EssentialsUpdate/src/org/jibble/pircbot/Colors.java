...
/**
 * The Colors class provides several static fields and methods that you may find useful when writing an IRC Bot. <p>
 * This class contains constants that are useful for formatting lines sent to IRC servers. These constants allow you to
 * apply various formatting to the lines, such as colours, boldness, underlining and reverse text. <p> The class
 * contains static methods to remove colours and formatting from lines of IRC text. <p> Here are some examples of how to
 * use the contants from within a class that extends PircBot and imports org.jibble.pircbot.*;
 *
 ...
 * IRC clients may be unable to correctly display lines that contain colours and other control characters. <p> Note that
 * this class name has been spelt in the American style in order to remain consistent with the rest of the Java API.
 *
 *
 * @since 0.9.12
