 ...
 * further information. <p> If you override the onServerResponse method in the PircBot class, you may find these
 * constants useful when comparing the numeric value of a given code.
 *
 * @since 1.0.0
