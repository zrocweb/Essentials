...
/**
 * A Thread which is responsible for sending messages to the IRC server. Messages are obtained from the outgoing message
 * queue and sent immediately if possible. If there is a flood of messages, then to avoid getting kicked from a channel,
 * we put a small delay between each one.
 *
...
public class OutputThread extends Thread
{
	...
	/**
	 * A static method to write a line to a BufferedOutputStream and then pass the line to the log method of the
	 * supplied PircBot instance.
	 *
	 * @param bot The underlying PircBot instance.
